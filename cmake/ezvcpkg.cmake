...
macro(EZVCPKG_BOOTSTRAP)
    if (NOT EXISTS ${VCPKG_EXE})
        ...
        message(STATUS "EZVCPKG Checking out commit ${VCPKG_COMMIT}")
        execute_process(
...
macro(EZVCPKG_BUILD)
    message(STATUS "EZVCPKG Building/Verifying packages ${VCPKG_PACKAGES}")
    execute_process(
...
macro(EZVCPKG_CLEAN)
    message(STATUS "EZVCPKG Cleaning unused ezvcpkg dirs after ${VCPKG_CLEAN} days")
