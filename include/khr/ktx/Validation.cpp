...
static const std::unordered_set<uint32_t> VALID_GL_INTERNAL_COMPRESSED_FORMATS {
    ...
    (uint32_t)GLInternalFormat::COMPRESSED_RGB_S3TC_DXT1_EXT,
    (uint32_t)GLInternalFormat::COMPRESSED_SRGB_S3TC_DXT1_EXT,
    (uint32_t)GLInternalFormat::COMPRESSED_RGBA_S3TC_DXT1_EXT,
    (uint32_t)GLInternalFormat::COMPRESSED_RGBA_S3TC_DXT5_EXT,
